...
const experiences = [
  ...
  {
    title: "Industrial Data Analyst & Developer",
    company: "Société Tunisienne de Sidérurgie ElFouladh",
    location: "Tunis",
    date: "SEP 2024 - FEB 2025",
    description: [
      "Designed and implemented interactive dashboards for industrial analytics and KPIs using Power BI.",
      "Developed web applications to monitor and analyze machine logs for predictive maintenance.",
      "Integrated Python with industrial systems using WinCC and custom scripts..",
    ],
