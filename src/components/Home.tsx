    ...
    <div className="home">
      ...
      <div className="socials">
        <div className="socialIcon">
          <a
            href="https://www.linkedin.com/in/badi-arfaoui/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <div className="socialIcon">
          ...
          <a
            href="https://github.com/ArfaouiBadi"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <div className="socialIcon">
          <a
            href="https://drive.google.com/file/d/1IECs7PlHxfgNYv6MYLbxI_ATnqJLfSel/view?usp=drive_link"
            target="_blank"
            rel="noreferrer"
          >
            Get CV
